  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#F4F6FB]">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-7xl flex-col px-6 py-8 lg:px-10">
        ...
        <div
          className={`flex flex-1 items-center ${isMinimal ? 'py-8 lg:py-10' : 'py-10 lg:py-14'}`}
        >
          <div
            className={
              isMinimal
          ...
          >
            ...
            <motion.section
              initial={{ opacity: 0, x: isMinimal ? 0 : 24, y: 12 }}
              animate={{ opacity: 1, x: 0, y: 0 }}
              transition={{ duration: 0.6, delay: 0.1 }}
              className={`mx-auto w-full ${isMinimal ? 'max-w-[520px]' : 'max-w-[560px]'}`}
            >
              <div
