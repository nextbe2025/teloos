...
export function WhyTeloosSection() {
  const [activeTab, setActiveTab] = useState(REASONS[0])
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="grid gap-16 lg:grid-cols-[400px_1fr] lg:items-center">
          ...
          <div className="flex flex-col gap-4">
            {REASONS.map((reason) => {
              const isActive = activeTab.id === reason.id
              ...
              return (
                <button
                  ...
                  className={cn(
                    'relative flex w-full flex-col items-start rounded-[2rem] p-8 text-left transition-all duration-300',
                    isActive
                ...
                >
                  ...
                  <span
                    className={cn(
                      'absolute top-6 right-6 text-5xl font-black transition-opacity',
                      isActive
                        ? 'text-brand-blue opacity-10'
                        : 'text-brand-dark opacity-5'
                    )}
                  >
                    {reason.number}
                  </span>

                  <div className="text-brand-blue mb-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-white shadow-sm ring-1 ring-gray-100">
                      ...
                      >
                        ...
                        >
                          ...
                          <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className={cn(
                              'shadow-brand-dark/10 relative flex h-8 w-8 items-center justify-center rounded-full border-2 shadow-xl transition-all duration-300',
                              isOpen
